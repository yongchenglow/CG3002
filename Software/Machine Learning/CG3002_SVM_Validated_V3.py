...
df = pd.read_csv('/home/pi/Desktop/CG3002/Software/DanceDanceData/data091117/Consolidated_Fever_091117.csv') 
...
##### segmentation #####
segmented_df = segment_signal(X, 100)
...
time_feature_list.to_csv("fever_feature_list.csv")
y_list.to_csv("fever_y_list.csv")
